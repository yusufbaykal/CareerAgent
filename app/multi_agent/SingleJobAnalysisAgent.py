...
class SingleJobAnalysisAgent(Agent):
    def __init__(self, workflow_id: str = None, **kwargs):
        super().__init__(
            ...
            instructions=[
                "İş ilanı metnini analiz et ve anahtar bilgileri çıkar.",
                "İş unvanı, şirket adı, anahtar teknolojiler/yetenekler, sorumluluklar, nitelikler, konum gibi bilgileri çıkar.",
